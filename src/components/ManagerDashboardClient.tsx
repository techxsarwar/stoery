                        ...
                        <div>
                           <div className="flex items-center gap-3">
                              ...
                              <span className={`text-[8px] font-black uppercase tracking-widest px-3 py-1 rounded-full border-2 ${
                                 member.role === 'ADMIN' ? 'bg-primary border-on-surface text-on-surface' : 'bg-surface/5 text-on-surface/40 border-on-surface/10'
                              }`}>
                                 {member.role}
                              </span>
                           </div>
        ...
        <nav className="flex-1 p-6 flex flex-col gap-3 overflow-y-auto custom-scrollbar">
           {tabs.map((tab) => (
             <button
               ...
               className={`flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-200 group border-4 ${
                  activeTab === tab.name 
