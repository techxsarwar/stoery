  ...
  return (
    <div className="min-h-screen bg-surface pt-20 sm:pt-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 pb-20 sm:pb-32 mt-6 sm:mt-8">
        ...
        <Suspense fallback={<div className="animate-pulse flex flex-col gap-8"><div className="h-64 bg-surface-container-high border-4 border-on-surface"></div><div className="h-64 bg-surface-container-high border-4 border-on-surface"></div></div>}>
          <FeedContent />
        </Suspense>
      </div>
    </div>
