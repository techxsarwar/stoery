    ...
    <div className="min-h-screen bg-surface flex flex-col items-center pt-24 px-6 md:px-12 w-full mx-auto pb-32">
      ...
      <main className="w-full max-w-4xl flex flex-col gap-12 mt-8">
        ...
        <article className="prose prose-p:font-body prose-headings:font-headline prose-p:text-lg prose-p:leading-relaxed max-w-none w-full bg-white p-8 md:p-12 border-4 border-on-surface shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] text-[#171717]">
            ...
            <p>Welcome to SOULPAD. By accessing this platform, creating an account, or publishing content, you agree to abide by the following directives.</p>

            <h2>1. Content Authorization & Ownership</h2>
            <p><strong>You Own Your Work.</strong> SOULPAD claims absolutely zero copyright or ownership over the original stories, manga, or art you create and publish here. You retain all intellectual property rights.</p>
            <p><strong>Display License:</strong> By publishing on SOULPAD, you grant us a worldwide, non-exclusive, royalty-free license to host, display, and distribute your content strictly within the context of the platform.</p>

            <h2>2. Platform Conduct (The Hard Lines)</h2>
            <p>SOULPAD encourages dark, mature, and complex themes ("Noir Aesthetics", "Dark Psychology"). However, fiction must remain fiction. The following are strictly forbidden:</p>
            <ul>
            ...
            <p>SOULPAD respects the intellectual property rights of creators globally. If you believe that your copyrighted work has been copied, scraped, or published on SOULPAD without your authorization, you must submit a formal Takedown Notice.</p>
            ...
            <p className="font-bold">By continuing to use SOULPAD, you acknowledge these terms. Break the rules, and you lose access to the universe.</p>
        </article>
      </main>
    </div>
  );
